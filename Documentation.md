...
Promotional Material: put this up front so we see it first;
Link to the prototype, and how to use it;
Summary: what is the problem space and how did you address it?
Process: how did you tackle this problem? Use images and extended captions to explain the design process and how your ideas evolved. Mention any limitations and relevant theory (Broke this into ‘Process’ & ‘Development Process’).
...
Login an account or create an account for first time user
Select “My Lunch Box” button to get overview of today’s lunch box
Edit or add new lunch box
Select “My Recipe” button or “Shared Recipe” button
For “Shared Recipe”, filter the type and status of recipe to select desired recipe
For “My Recipe”, select existing recipe or create a new recipe
To create a new recipe, enter the name, type, description, ingredients and required steps for to create a new recipe
Once a recipe is added to a lunch box, all relevant ingredients will be added into shopping list
Description of an ingredient can be viewed through tapping the icon of the ingredient in recipe, shopping list or through a categorized food library
...
Taking this into consideration the team, ‘Frying Nemo’, is dedicated towards developing and implementing an application which establish a connection between parents and teachers in creating and maintaining a meal plan for children easily, healthily and above all tasty.
...
https://drive.google.com/open?id=1B2Z4rFTDwH2LBgEPQO2QOUqJkZPjjiP0dbVS6emW_6k
> Original Persona’s
...
Approximation of nutrition data will be automatically calculated when a recipe is created to give user a better visualisation of the nutrition value of the meal.
This nutritional data will be collated and a visual representation of the users calorie intake and nutritional breakdown will be able to be displayed to them at any given time.
Shopping List
...
Allow for multiple users to access and make use of the application. Their data being transferable across their account.
 ...
 Markup : * Recipe creating and sharing
            * Users (parents, children and teachers) will be able to create recipe for the child’s lunchbox and even share the recipe to the community for other users, should they wish.
          * Nutrition Calculation
            * Approximation of nutrition data will be automatically calculated when a recipe is created to give user a better visualisation of the nutrition value of the meal.
            This nutritional data will be collated and a visual representation of the users calorie intake and nutritional breakdown will be able to be displayed to them at any given time.
